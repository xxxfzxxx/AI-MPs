...
def hyperparameters():
    ...
    parser.add_argument('--episodes', type=int, default=150, help='number of episodes to simulate per iteration')
    parser.add_argument('--trainsize', type=int, default=20000, help='number of training steps to take per iteration')
    parser.add_argument('--epsilon', type=float, default=0.3, help='exploration parameter')
